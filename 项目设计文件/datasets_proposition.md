...
### 🆕 数据集27：Resume Dataset（简历分类）✅ 已下载 ⏳ 待测试
...
### 🆕 数据集29：AI驱动简历筛选数据集（2025）✅ 已下载 ⏳ 待测试
...
### 🆕 数据集30：Resumes 原始PDF简历分类数据集（HuggingFace）✅ 已下载 ⏳ 待测试（本地完整存档）
